export default function Speakers() {
    return(
        ...
        <div className="col-md-4 col-sm-6 feature">
          ...
          <h3>Simon Collins</h3>
          <p>Simon is designer and partner at Fictivekin and has worked in a variety of situations htmlFor bands, record labels, governments, polar explorers, and most other things...</p>
        ...
        <div className="col-md-4 col-sm-6 feature">
          ...
          <p>Stephie is a user experience researcher and designer. In over 15 years of working on the web, she has worn many hats, including a product lead htmlFor a tech startup in publishing...</p>
          <ul className="speaker-social">
            <li><a href="#"><span className="ti-facebook"></span></a></li>
            <li><a href="#"><span className="ti-twitter-alt"></span></a></li>
            <li><a href="#"><span className="ti-linkedin"></span></a></li>
        ...
        <div className="col-md-4 col-sm-6 feature">
          ...
          <h3>Harry Roberts</h3>
          <p>Harry is a freelance designer, developer, writer, speaker and front-end architect from the UK, previously working as Senior UI Developer htmlFor Sky. He Tweets at...</p>
          <ul className="speaker-social">
            <li><a href="#"><span className="ti-facebook"></span></a></li>
            <li><a href="#"><span className="ti-twitter-alt"></span></a></li>
            <li><a href="#"><span className="ti-linkedin"></span></a></li>
