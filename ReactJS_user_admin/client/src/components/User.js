...
export default function User({_id, firstName, lastName, email, imageUrl, phoneNumber, createdAt, onInfoClick, onDeleteClick, onEditClick}){
    return(
        <tr>
              <td>
                <img src={imageUrl}
              ...
              <td>{email}</td>
              <td>{phoneNumber}</td>
              <td>{dateUtils.FormDate(createdAt)}</td>
